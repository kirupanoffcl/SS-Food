                ...
                <div class="card card-small mb-4">
                  ...
                  <div class="card-body p-0 pb-3 text-center">
                    <table class="table mb-0">
                      ...
                      <tbody>
<?php $query=mysqli_query($con,"select distinct orders.bill_no,orders.orderDate,orders.paymentMethod,orders.userId,orders.id,users.name,users.contactno from orders join users on orders.userId=users.id ORDER BY bill_no DESC");
$cnt=1;
while($row=mysqli_fetch_array($query)){
?>					  
                        <tr>
