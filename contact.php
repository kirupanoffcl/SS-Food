...
if(isset($_POST['submit'])){
	...
	$query=mysqli_query($con,"insert IGNORE  into messages(name,email,subject,message) 
	    		...
	    		<div class="col-sm-4">
	    			<div class="contact-info">
	    				...
	    				<address>
							...
							<p>Mobile: +94777123456</p>
							<p>Fax: 1-714-252-0026</p>
							<p>Email: contact@SS-FOOD.com</p>
	    				</address>
